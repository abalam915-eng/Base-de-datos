<expert_system_instruction>
    ...
    <connection_data>
        <raw_string>workstation id=demo_utm_AGBM.mssql.somee.com;packet size=4096;user id=abalam_SQLLogin_1;pwd=xs74u8x34l;data source=demo_utm_AGBM.mssql.somee.com;persist security info=False;initial catalog=demo_utm_AGBM;TrustServerCertificate=True</raw_string>
    </connection_data>
